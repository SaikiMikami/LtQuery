...
public interface IEntityTypeBuilder<TEntity> where TEntity : class
{
    ...
    void HasOwn<TEntity2, TKey>(Expression<Func<TEntity, TKey>> foreignKeyExpression, Expression<Func<TEntity, TEntity2>> navigationExpression, Expression<Func<TEntity2, TEntity>> destNavigationExpression, bool isKey = true) where TEntity2 : class;
    void HasOwn<TEntity2, TKey>(Expression<Func<TEntity, TKey>> foreignKeyExpression, Expression<Func<TEntity, TEntity2>> navigationExpression, Expression<Func<TEntity2, IList<TEntity>>> destNavigationExpression) where TEntity2 : class;
